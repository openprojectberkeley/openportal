...
// staging area for the project's upcoming round (applicants move in from the
// Wishlist via a button there); Confirmed is what's already been submitted
// this draft, across every round so far.
